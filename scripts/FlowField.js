...
var FlowField = (function () {
    function FlowField(width, height, canvas) {
        if (canvas === void 0) { canvas = null; }
        //private color:net.brehaut.Color;
        this.color = toxi.color.TColor.newRGB(1, 1, 1);
        this.t_center = new PIXI.Point(0, 0);
        this.range = 20;
        this.t = 0;
        this.deltaT = 0.005;
        this.vCell = new Vec2(0, 0);
    ...
    FlowField.prototype.initField = function () {
        var vCell = new Vec2();
        var a1 = -2.5;
        var b1 = 7;
        var a2 = -6.75;
    ...
    FlowField.prototype.initPerlinField = function () {
    ...
    FlowField.prototype.perlinField = function () {
        this.t += this.deltaT;
    ...
    FlowField.prototype.lookup = function (vLookup) {
    ...
    FlowField.prototype.modify = function () {
        var vCell = new Vec2();
        for (var i = 0; i < this.vArray.length; i++) {
            for (var j = 0; j < this.vArray[1].length; j++) {
