...
declare class PIXI {
    ...
    static autoDetectRenderer(width: number, height: number, options?: PIXI.RendererOptions, noWebGL?: boolean): any;
...
declare module PIXI {
    ...
    export class DisplayObject extends EventEmitter implements interaction.InteractiveTarget {
        ...
        generateTexture(renderer: any, scaleMode: number, resolution: number): Texture;
        destroy(): void;
    ...
    export class Graphics extends Container {
        ...
        clear(): Graphics;
        //todo
        //generateTexture(renderer: any, resolution?: number, scaleMode?: number): Texture;
        getBounds(matrix?: Matrix): Rectangle;
    ...
    export class CanvasMaskManager {
        ...
        pushMask(maskData: any, renderer: any): void;
        popMask(renderer: any): void;
        destroy(): void;
    ...
    export class RenderTexture extends Texture {
        ...
        constructor(renderer: any, width?: number, height?: number, scaleMode?: number, resolution?: number);
    ...
    export module extras {
        ...
        export class TilingSprite extends Sprite {
            ...
            getBounds(): Rectangle;
            generateTilingTexture(renderer: any, texture: Texture, forcePowerOfTwo?: boolean): Texture;
            containsPoint(point: Point): boolean;
            destroy(): void;
    ...
    export module interaction {
        ...
        export class InteractionManager {
            ...
            constructor(renderer: any, options?: { autoPreventDefault?: boolean; interactionFrequence?: number; });
